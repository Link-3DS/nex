# This file comes from the NintendoClients because I'm too lazy to rewrite the names of the errors
# https://github.com/kinnay/NintendoClients/blob/master/nintendo/nex/errors.py
